                ...
                <View style={{height: 350, width: '100%'}}>
                    ...
                    <View style={{paddingTop: 10}}>
                        ...
                        <View style={{height: '100%', width: '100%', display: 'flex', flexDirection:'row', justifyContent: 'space-around', flexWrap: 'wrap'}}>
                            <TouchableOpacity style={{height: 70, width: '46%', backgroundColor: '#272829', borderRadius: 10, overflow: 'hidden', display: 'flex', flexDirection:'row', marginBottom: 10}} onPress={() => navigation.navigate('Home')}>
