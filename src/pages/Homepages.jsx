...
const HomePages = ( {navigation}) => {
    ...
    const getNamaWaktu = () => {
        ...
        if (jamSekarang >= 5 && jamSekarang < 12) {
            setNamaWaktu('Selamat Pagi');
        } else if (jamSekarang >= 12 && jamSekarang < 16) {
            setNamaWaktu('Selamat Siang');
        } else if (jamSekarang >= 16 && jamSekarang < 19) {
            setNamaWaktu('Selamat Sore');
        } else {
            setNamaWaktu('Selamat Malam');
        }
    };
                    ...
                    <View style={{height: 350, width: '100%'}}>
                        <View style={{height: 180}}>
                            ...
                            <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
                                <Text style={{fontSize: 20, fontFamily:'Poppins-Medium', marginBottom: 20, color: 'white', marginLeft: 10}}>{namaWaktu}</Text>
                        ...
                        <View style={{}}>
                            <View style={{paddingTop: 10}}>
                                {/* bagian card music */}
                                <View style={{marginTop: 20, width: '100%', display: 'flex', flexDirection:'row', justifyContent: 'space-around', flexWrap: 'wrap'}}>
