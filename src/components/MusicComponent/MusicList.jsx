...
const MusicList = (props) => {
    const {id, img, title, artist, album, duration, path, favorite, filedate, filesize} = props;
        ...
        <>
            <View style={{height: 80, width: '100%', flexDirection: "row", marginBottom: 5}}>
                <View style={{width: 80, justifyContent: "center", alignItems: "center"}}>
                    <Image style={{height: 50, width: 50, borderRadius: 5}} source={{uri: imgbase64}} />
                </View>
                <View style={{flex: 1, justifyContent: "center"}}>
                    <Text numberOfLines={1} ellipsizeMode="tail" style={{fontFamily: 'Poppins-Regular', fontSize: 14, color: textcolor ? "#FFFF00" : "#FFFFFF"}}>{title}</Text>
                    <Text numberOfLines={1} ellipsizeMode="tail" style={{fontFamily: 'Poppins-Regular', fontSize: 12, color: '#808080'}}>{artist} • {album}</Text>
                    <Text numberOfLines={1} ellipsizeMode="tail" style={{fontFamily: 'Poppins-Regular', fontSize: 12, color: '#808080'}}>{duration}</Text>
                </View>
